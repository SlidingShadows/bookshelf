...
{
    public partial class StarterBookScheme : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Books_Countries_CountyId",
                        column: x => x.CountyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlterNames", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AlterNames_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.UpdateData(
                ...
                value: "f50c95d9-c810-4371-b92c-b21ea0c50d85");
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "e029810a-4bc1-450d-b676-71972458e173", "AQAAAAEAACcQAAAAEMVL5tAuBXE7Qyw1dnzH6opBR+C2EslFqkUv00wTuomLoCCVsd8JNTG4LtZdn1ea0g==" });

            migrationBuilder.CreateIndex(
                name: "IX_AlterNames_BookId",
                table: "AlterNames",
                column: "BookId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("e6a84561-2b8e-4c7b-a2c4-1e0269c8c593"),
                column: "ConcurrencyStamp",
                value: "69719f86-4f2a-45d3-b572-dca59e87534d");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("adffb8b5-e90d-4163-a60f-1d290509260e"),
                columns: new[] { "ConcurrencyStamp", "PasswordHash" },
                values: new object[] { "dd59059e-010b-4913-b047-f2173ce781a5", "AQAAAAEAACcQAAAAEKvEYOXp7y+1i83v96BACfRc7fbi42ZTqr/GqKNyoadYqpcUAH8W/gm5/W3ZKildkg==" });
        }
    }
}
